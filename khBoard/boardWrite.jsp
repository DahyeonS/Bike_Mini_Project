...
<script>
	...
	function insertWrite () {
    	...
    	sendAjax('insertWrite.json', params).then( (data) => {
    		if(data['rs'] == 1) {
			...
			<div class="card mb-4 border-light justify-content-md-center">
				...
				<div class="card-body" data-wow-delay=".5s">
					<div class="rounded contact-form">
						<div class="mb-4">
							<input type="text" class="form-control p-3" placeholder="제목"
								id="title"><br>
						...
						<div class="mb-4" align="center">
							<input class="btn btn-secondary btn-sm" type="button"
								value="작성 완료" id="writeBtn" />
							<button class="btn btn-secondary btn-sm" type="reset">다시
								입력</button>
