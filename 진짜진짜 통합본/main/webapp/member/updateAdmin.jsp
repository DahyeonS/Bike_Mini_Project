...
<form id="member">
	<table>
		<tr class="update"><th>아이디</th><td><input type="text" name="id" id="id" readonly="readonly"></td></tr>
		<tr class="update"><th>닉네임</th><td><input type="text" name="nickname" id="nickname">&nbsp&nbsp
...
<% 		String seGrade = (String)session.getAttribute("grade");
		...
		<tr class="update"><td colspan="2"><select name="grade" id="grade">
			<option value="ASSOCIATE">부매니저</option>
			<option value="STAFF">스태프</option>
			<option value="GENERAL" selected="selected">일반회원</option>
		</select></td></tr>
<% 		} %>
		<tr class="update"><th colspan="2">&nbsp</th><td><input type="button" value="수정하기" id="submit"></td></tr>
		<tr class="update"><th>&nbsp</th></tr>
		<tr class="update"><th colspan="2">&nbsp</th><td><input type="button" value="회원탈퇴" id="delete" onclick="memberDeleteConfirm();"></td></tr>
	</table>
</form>
</body>
</html>