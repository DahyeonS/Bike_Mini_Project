...
<script>
	...
	$(function name() {  // 실행시 자동으로 실행
		$('#uploadBtn').on('click', function() { 
			const imageInput = $('#attechedFile')[0];
						...
						<div class="mb-4">
							...
							<form method="post" enctype="multipart/form-data" name="form" id="form">
								<div class="relative top-0 start-0" style="float:left;">
									첨부파일 : <input class="btn" type="file" value="업로드 하기" id="attechedFile"/>
								</div>
								<div class="mb-4" align="center" style="float:right;">
									<input class="btn btn-secondary btn-sm" type="button" value="작성 완료" id="uploadBtn" /> 
